...
import { AiTemplatesService } from '../../ai/ai-templates.service';
import { buildDocumentContent } from '../../ai/document-content.util';
import { ProjectReportService } from '../reports/project-report.service';
import { endOfRangeExclusive, toDateOnly } from '../reports/working-day.util';
import { QueryProjectAiSummaryDto } from './dto/query-project-ai-summary.dto';
