...
function FieldLegend({
    ...
    return (
        <legend
            ...
            className={cn(
                'mb-3 font-medium data-[variant=label]:text-sm data-[variant=legend]:text-sm',
                className
            )}
            {...props}
        />
...
function FieldDescription({ className, ...props }: React.ComponentProps<'p'>) {
    return (
        <p
            ...
            className={cn(
                'text-left text-xs leading-normal font-light tracking-normal text-content-muted normal-case group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5',
