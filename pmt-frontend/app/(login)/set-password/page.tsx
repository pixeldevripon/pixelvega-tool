...
/**
 * Where the invite email lands. The path is fixed by the backend, which builds
 * the link as `${APP_URL}/set-password?token=...` in `sendResetPassword`.
...
async function Card({
    ...
    return <NewPasswordCard mode='invite' expired={state === 'expired'} />;
}
