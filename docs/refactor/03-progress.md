...
| 1.12 | Fix `pmt-frontend/.env.example`                                 | done     | Fixed, and ports changed with it: backend **5050**, frontend **3000**. `lib/api/client.ts` carried the same self-pointing fallback                                                       |
