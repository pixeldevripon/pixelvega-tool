...
| 6.10 | Response DTOs: `ai`, `ai-summary`, `ai-status-reports`, `auth`                   | done    | `ai` (3 dto files to 1), `ai-summary`, `ai-status-reports` and `auth` (3 to 1). AI jobs gained `isFinished`, so a polling client cannot loop forever on a FAILED job                                                                                                                                           |
